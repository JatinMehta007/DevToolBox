    ...
    <>
      ...
      <p className="text-base md:text-xl p-3 xl:p-0 xl:text-xl tracking-wide text-gray-300 text-center mt-1 max-w-2xl mx-auto">
        ...
        <div className="grid grid-cols-1  lg:grid-cols-3 gap-4 mx-auto  relative px-1 sm:px-10 md:px-20 lg:px-0 lg:right-14">
          ...
          <WobbleCard containerClassName="col-span-1 min-h-[450px] lg:min-h-[300px] p-3 border border-gray-700 lg:border-0 bg-purple-900 relative w-full -3 lg:p-0 lg:right-24 lg:w-[480px] xl:w-[590px]">
          ...
          <WobbleCard 
            containerClassName="col-span-1 lg:col-span-2 border border-gray-700 lg:border-0  p-3 lg:p-0 h-full bg-blue-900 w-full lg:w-[70%] xl:w-[75%] min-h-[500px] lg:min-h-[300px]"
            className=""
            >
          ...
          <WobbleCard containerClassName="col-span-1 min-h-[450px] lg:min-h-[300px] p-3 border border-gray-700 lg:border-0 bg-red-900 relative w-full -3 lg:p-0 lg:right-24 lg:w-[480px] xl:w-[590px]">
          ...
          <WobbleCard containerClassName="col-span-1 min-h-[450px] lg:min-h-[300px] p-3 border border-gray-700 lg:border-0 bg-yellow-600 relative w-full -3 lg:p-0 lg:right-24 lg:w-[480px] xl:w-[590px]">
          ...
          <WobbleCard containerClassName="col-span-1 min-h-[450px] lg:min-h-[300px] p-3 border border-gray-700 lg:border-0 bg-violet-900 relative w-full -3 lg:p-0 lg:right-24 lg:w-[480px] xl:w-[590px]">
