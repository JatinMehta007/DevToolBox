    ...
    <>
      ...
      <div className="bg-black h-full  pt-28 space-y-5">
        <h1 className=" text-center text-3xl sm:text-5xl p-3 xl:p-0 xl:text-7xl tracking-normal leading-tight font-black xl:mt-12 text-white ">
          Top Fonts for Developers & <br /> <span>Designers</span>
        </h1>
        <p className="text-base md:text-xl p-3 xl:p-0 xl:text-xl tracking-wide text-gray-300 text-center mt-1 max-w-2xl mx-auto">
          Handpicked fonts like Inter, Poppins, and Roboto for web design and
          frontend development. Preview and use instantly.
        </p>
            ...
            >
              <div className="max-w-xs">
                ...
                <p className="mt-4 text-left  text-base/6 text-neutral-200">
                  1,500+ open-source fonts, Fast CDN (served from Google
                  servers), Easy to embed in HTML or CSS, Previews for each font
                  in different weights, Supports language subsets
                </p>
          ...
          >
            ...
            >
              <div className="max-w-xs">
                ...
                <p className="mt-4 text-left  text-base/6 text-neutral-200">
                  Every font you need, everywhere you need it Find the perfect
                  font. Premium fonts (paid Adobe Creative Cloud)
                </p>
                <p className="text-white/90 font-medium inline-flex items-center mt-5 gap-2">
                  Click the image
                  <ArrowRight className="w-4 h-4"></ArrowRight>
          ...
          >
            ...
            >
              <div className="max-w-xs">
                ...
                <p className="mt-4 text-left  text-base/6 text-neutral-200">
                  Font pairing made simple. Generate font combinations with deep
                  learning
                </p>
                <p className="text-white/90 font-medium inline-flex items-center mt-5 gap-2">
                  Click the image
        ...
        <div className="grid grid-cols-1  lg:grid-cols-3 gap-4 mx-auto  relative px-1 sm:px-10 md:px-20 lg:px-0 lg:right-14">
          ...
          >
            ...
            >
              <div className="max-w-xs">
                ...
                <p className="mt-4 text-left  text-base/6 text-neutral-200">
                  Free fonts have met their match. We know how hard it is to
                  find quality freeware that is licensed for commercial work.
                </p>
                <p className="text-white/90 font-medium inline-flex items-center mt-5 gap-2">
                  Click the image
                  <ArrowRight className="w-4 h-4"></ArrowRight>
          ...
          <WobbleCard containerClassName="col-span-1 min-h-[450px] lg:min-h-[300px] p-3 border border-gray-700 lg:border-0 bg-indigo-800 relative w-full -3 lg:p-0 lg:right-24 lg:w-[480px] xl:w-[590px]">
            ...
            >
              ...
              <p className="mt-4 max-w-[18rem] text-left  text-base/6 w-[50%] text-neutral-200">
