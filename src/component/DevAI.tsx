      ...
      <Skeleton></Skeleton>
        ...
        <div className="grid grid-cols-1  lg:grid-cols-3 gap-4 mx-auto  relative p-1 md:right-14">
          ...
          >
            ...
            >
              <div className="max-w-base md:max-w-base md:max-w-xs ">
                <h2 className="text-left text-balance text-xl sm:text-2xl md:text-xl lg:text-3xl font-semibold tracking-[-0.015em] text-white">
                 ChatGPT
                </h2>
           ...
           <WobbleCard containerClassName="col-span-1 min-h-[450px] md:min-h-[300px] p-3 border border-gray-700 md:border-0 bg-blue-800 relative w-full -3 md:p-0 md:right-24 md:w-[600px]">
            ...
            <h2 className="max-w-96  text-left text-balance text-xl md:text-xl lg:text-3xl font-semibold tracking-[-0.015em] text-white">
            Gemini
            </h2>
            <p className="mt-4 max-w-base md:max-w-[18rem] text-left  text-base/6 text-neutral-200">
